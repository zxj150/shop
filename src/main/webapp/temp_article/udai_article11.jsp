		...
		<section class="user-center inner clearfix">
			<div class="pull-left bgf">
				...
				<dl class="user-center__nav">
					...
					<a href="udai_article11.jsp"><dd class="active">加入U袋</dd></a>
			...
			<div class="pull-right bgf">
				<div class="user-center__content">
					...
					<div class="html-code">
						<h3>加入U袋</h3>
						<blockquote><ul>
							<li>有 BUG 可以在<a href="http://rm.66rpg.com/forum-320-1.jsp" target="_blank" rel="external">【这里】</a>提问、反馈，不过我并不一定能解决。</li>
