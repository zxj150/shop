		...
		<section class="user-center inner clearfix">
			<div class="pull-left bgf">
				...
				<dl class="user-center__nav">
					...
					<a href="udai_paypwd_modify.jsp"><dd class="active">修改支付密码</dd></a>
							...
							$(document).ready(function(){
								...
								$('#getsms').click(function() {
									...
									switch(phone.validatemobile()) {
										case 0:
											// 短信验证码的php请求
											error.jsp('验证码 <strong>已发送</strong>');
											$(this).rewire(60);
										break;
										case 1: error.jsp('<strong>手机号码为空</strong> 请输入手机号码'); break;
										case 2: error.jsp('<strong>手机号码错误</strong> 请输入11位数的号码'); break;
										case 3: error.jsp('<strong>手机号码错误</strong> 请输入正确的号码'); break;
									}
								});
							});
						</script>
