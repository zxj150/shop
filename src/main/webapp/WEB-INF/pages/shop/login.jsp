	...
	<div style="background:url(images/login_bg.jpg) no-repeat center center; ">
		<div class="login-layout container">
					...
					<form class="tabs_form" action="" method="post" id="login_form">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control password" name="userPass" id="userCode" placeholder="请输入密码" autocomplete="off" type="password">
			...
			<div class="form-box register">
  				...
  				<div class="tabs_container" id="model_user">
					<form class="tabs_form" action="index.jsp" method="post" id="register_form">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control name" name="userName" id="register_name" required placeholder="用户名称" autocomplete="off" type="text">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control phone" name="userTlp" id="register_phone" required placeholder="手机号" maxlength="11" autocomplete="off" type="text">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control phone" name="userCode" id="register_phone" required placeholder="账号" maxlength="11" autocomplete="off" type="text">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control password" name="userPass" id="register_pwd" placeholder="请输入密码" autocomplete="off" type="password">
								<div class="input-group-addon pwd-toggle" title="显示密码"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></div>
							</div>
						</div>
						<div class="checkbox">
	                    ...
	                    <button class="btn btn-large btn-primary btn-lg btn-block submit" id="button_submit" type="button">注册</button>
                    </form>
                    <div class="tabs_div">
	                    <div class="success-box">
	                    	<div class="success-msg">
					...
					<form class="tabs_form" action="https://rpg.blue/member.php?mod=logging&action=login" method="post" id="resetpwd_form">
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control phone" name="userName" id="resetpwd_phone" required placeholder="用户名称"  autocomplete="off" type="text">
							</div>
						</div>
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control phone" name="userCode" id="resetpwd_phone" required placeholder="账号"  autocomplete="off" type="text">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input class="form-control password" name="userPass" id="resetpwd_pwd" placeholder="新的密码" autocomplete="off" type="password">
								<div class="input-group-addon pwd-toggle" title="显示密码"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></div>
							</div>
						</div>
						<div class="form-group">
