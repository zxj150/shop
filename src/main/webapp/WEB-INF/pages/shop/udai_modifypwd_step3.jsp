		...
		<section class="user-center inner clearfix">
			<div class="pull-left bgf">
				...
				<dl class="user-center__nav">
					...
					<a href="udai_pwd_modify.jsp"><dd class="active">修改登录密码</dd></a>
				</dl>
				<dl class="user-center__nav">
					<dt>订单中心</dt>
			...
			<div class="pull-right">
				<div class="user-content__box clearfix bgf">
					...
					<div class="modify-success__box text-center">
						...
						<a href="login.jsp" class="btn"><span id="sec">3</span> 秒后跳转至登陆页面，如果浏览器未跳转请点击这里</a>
					</div>
					<script>
						$(document).ready(function(){
							...
							window.setInterval(function(){
								$('#sec').jsp(time--);
								if (time < 0) {window.location.href = 'login.jsp'}
							}, 1000);
						});
					</script>
				</div>
